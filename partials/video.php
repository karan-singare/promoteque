<div class="video-container">
  <div class="video">
    <video class="video" src="<?php echo get_images_path() . 'video.mp4' ?>"  loop muted playsinline autoplay preload="auto"  poster="<?php echo get_images_path() . 'poster.jpg' ?>" onload="console.log('helo')">
    </video>
  </div>
