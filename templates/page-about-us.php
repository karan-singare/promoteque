...
<section class="about-us-info">
  <div class="row">
    ...
    <h3 class="heading__secondary">Who are we?</h3>
    ...
    <p>
      ...
      digital world – with experience in many different disciplines of communication, from journalism, advertising, marketing and public relations to influencer and social-led content marketing, across geographies and business sectors. The founding
      idea behind The Social Edition stems from our belief that everyone has a story to tell, but you need the right tools and tactic to be heard. With The Social Edition, we help you tell your story right.
    </p>
...
<section class="administration">
  ...
  <div class="photo-composition photo-composition--1">
    <div class="row custom-row">
      <div class="photo-composition__content">
        <div class="photo-composition__content--left">
          <h2 class="photo-composition__title">
            Priyanka Mehra Dayal <br>
            <span>Founder</span>
          </h2>
        </div>
